...
console.log(
  `Validated ${cooks.length} profiles, ${audioTracks.length} audio mappings, ${portraitSources.length} portrait sources, ` +
    `${transcriptCount} transcripts, stable unique slugs, and ${printedSlugs.length} printed QR URLs.`,
);